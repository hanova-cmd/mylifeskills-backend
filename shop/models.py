...
class ShopItem(models.Model):
    ...
    def get_layer_config(self):
        layer_configs = {
            ...
            'pants': {'zIndex': 2, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
            'shoes': {'zIndex': 3, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
            'shirt': {'zIndex': 4, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
            'facial_hair': {'zIndex': 5, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
            'hair': {'zIndex': 6, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
            'glasses': {'zIndex': 7, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
            'hat': {'zIndex': 8, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
            'accessory': {'zIndex': 9, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
            'face': {'zIndex': 10, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
            'avatar': {'zIndex': 1, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
            'frame': {'zIndex': 11, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
            'badge': {'zIndex': 12, 'defaultX': 0, 'defaultY': 0, 'defaultWidth': 200, 'defaultHeight': 300},
        }
